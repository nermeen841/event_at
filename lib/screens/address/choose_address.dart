        ...
        return Directionality(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              backgroundColor: Colors.white,
              title: Text(
                translate(context, 'choose_address', 'title'),
                style: TextStyle(
                    fontSize: w * 0.05,
                    color: Colors.black,
                                    ...
                                    if (areasId.contains(_list[i].areaId)) {
                                      ...
                                      final snackBar = SnackBar(
                                        content: Text(translate(
                                            context, 'snack_bar', 'area')),
                                        action: SnackBarAction(
                                          label: translate(context, 'snack_bar',
                                              'area_button'),
        ...
        return Directionality(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              backgroundColor: Colors.white,
              title: Text(
                translate(context, 'choose_address', 'locations'),
                style: TextStyle(
                    fontSize: w * 0.05,
                    color: Colors.black,
                    fontWeight: FontWeight.bold),
